...
var extractDirectives = (el) => {
  if (!(el == null ? void 0 : el.attributes)) {
...
function getSwapDirective(el) {
  var _a;
  return ((_a = getDirectiveValue2(el, "swap")) == null ? void 0 : _a.expression) || "innerHTML";
}
var swapFunctions = {
...
function getTargetDirective(el) {
  ...
  if (target) {
    const selector = (_a = target.expression) == null ? void 0 : _a.trim();
    if (selector) {
...
function removeTargetDirectiveIfNecessary(el) {
  const target = getDirectiveValue2(el, "target");
  if (target == null ? void 0 : target.modifiers.includes("once")) {
...
function cleanup(root) {
  var _a;
  const refName = (_a = getDirectiveValue(root, "ref")) == null ? void 0 : _a.expression;
  if (refName) {
...
var valueSetters = /* @__PURE__ */ new Map([
  ["text", (el, value) => el.textContent = value != null ? value : ""],
  ["html", (el, value) => el.innerHTML = value != null ? value : ""],
  ["value", (el, value) => {
...
function getElementValue(el, bindType) {
  var _a, _b;
  return (_b = (_a = valueGetters[bindType]) == null ? void 0 : _a.call(valueGetters, el)) != null ? _b : el.getAttribute(bindType);
}
function setElementValue(el, bindType, value) {
  (valueSetters.get(bindType) || ((el2, value2) => el2.setAttribute(bindType, value2 != null ? value2 : "")))(el, value);
}
...
directive("init", ({ el, directive: directive2 }) => {
  var _a;
  const expression = (_a = directive2.expression) == null ? void 0 : _a.trim();
...
var DataCollection = class {
  constructor(el) {
    __publicField(this, "elementHandlers", {
...
var Request = class {
  ...
  getContentType(el) {
    var _a;
    const collectedData = collectData(el);
    return isForm(el) || collectedData.hasFiles() ? void 0 : ((_a = getDirectiveValue2(el, "enctype")) == null ? void 0 : _a.expression) || "application/json";
  }
  ...
  getTargetDirective(el) {
    var _a;
    const targetSelector = (_a = getDirectiveValue2(el, "target")) == null ? void 0 : _a.expression;
...
async function ifConfirm(el) {
  ...
  if (!(confirmDirective == null ? void 0 : confirmDirective.expression)) return true;
...
var getRequestMethodFromDirective = (directive2) => {
  var _a;
  return HTTP_METHODS.includes((_a = directive2.value) == null ? void 0 : _a.toLowerCase()) ? directive2.value.toLowerCase() : "get";
};
var EVENT_TYPE_MAP = {
  form: "submit",
  select: "change",
...
var isKeyEvent = (event) => {
  var _a;
  return (_a = event.type) == null ? void 0 : _a.startsWith("key");
};
...
directive("on", ({ el, directive: directive2 }) => {
  ...
  const options = {
    preventDefault: (modifiers == null ? void 0 : modifiers.has("prevent")) || false,
    stopPropagation: (modifiers == null ? void 0 : modifiers.has("stop")) || false,
    once: (modifiers == null ? void 0 : modifiers.has("once")) || false,
    capture: (modifiers == null ? void 0 : modifiers.has("capture")) || false,
    passive: (modifiers == null ? void 0 : modifiers.has("passive")) || false,
    self: (modifiers == null ? void 0 : modifiers.has("self")) || false,
    window: (modifiers == null ? void 0 : modifiers.has("window")) || false,
    document: (modifiers == null ? void 0 : modifiers.has("document")) || false,
    outside: (modifiers == null ? void 0 : modifiers.has("outside")) || false,
    rootMargin: (_a = modifiers == null ? void 0 : modifiers.get("rootMargin")) == null ? void 0 : _a.value,
    threshold: (_b = modifiers == null ? void 0 : modifiers.get("threshold")) == null ? void 0 : _b.value,
    delay: parseTime(((_c = modifiers == null ? void 0 : modifiers.get("debounce")) == null ? void 0 : _c.value) || "0"),
    throttle: parseTime(((_d = modifiers == null ? void 0 : modifiers.get("throttle")) == null ? void 0 : _d.value) || "0"),
    keyModifiers: Array.from((modifiers == null ? void 0 : modifiers.keys()) || []).filter((key) => key in keyCodeMap || MODIFIER_KEYS.includes(key))
  };
  try {
...
__publicField(_PBar, "DEFAULT_OPTIONS", {
  color: "#29d",
  height: "3px",
  duration: 300,
  delay: 300,
...
var NavigationManager = class {
  constructor() {
    __publicField(this, "handleNavigate", async (event) => {
    ...
    __publicField(this, "shouldInterceptClick", (event) => event.which > 1 || event.altKey || event.ctrlKey || event.metaKey || event.shiftKey);
    __publicField(this, "handlePopState", async () => {
...
function applyTransitionClasses(el, phase, duration) {
  var _a, _b, _c;
  const transitionClass = (_a = getDirectiveValue2(el, `transition:${phase}`)) == null ? void 0 : _a.expression;
  const startClass = (_b = getDirectiveValue2(el, `transition:${phase}-start`)) == null ? void 0 : _b.expression;
  const endClass = (_c = getDirectiveValue2(el, `transition:${phase}-end`)) == null ? void 0 : _c.expression;
...
function toggleState(el, directive2, isTruthy, cachedDisplay = null) {
  ...
  if (directive2.hasModifier("class")) {
    ...
    let cache2 = cachedDisplay != null ? cachedDisplay : getStyle(el, "display");
...
directive("stream", ({ el, directive: directive2 }) => {
  var _a;
  const url = directive2.expression;
  const swapMethod = ((_a = getDirectiveValue2(el, "swap")) == null ? void 0 : _a.expression) || "innerHTML";
...
directive("id", async ({ el, directive: directive2 }) => {
  var _a;
  const names = await evaluateInContext(el, (_a = directive2.expression) == null ? void 0 : _a.trim());
...
// builds/module.js
var module_default = asor_default;
